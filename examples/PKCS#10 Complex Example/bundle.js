(function (exports) {
  ...
  class LocalBaseBlock
  {
  	...
  	{
  		return {
  			blockName: LocalBaseBlock.blockName(),
  ...
  const LocalHexBlock = BaseClass => class LocalHexBlockMixin extends BaseClass
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalHexBlockMixin.blockName();
  ...
  class LocalIdentificationBlock extends LocalHexBlock(LocalBaseBlock)
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalIdentificationBlock.blockName();
  ...
  class LocalLengthBlock extends LocalBaseBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalLengthBlock.blockName();
  ...
  class LocalValueBlock extends LocalBaseBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalValueBlock.blockName();
  ...
  class BaseBlock extends LocalBaseBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = BaseBlock.blockName();
  ...
  class LocalPrimitiveValueBlock extends LocalValueBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalPrimitiveValueBlock.blockName();
  		object.valueHex = bufferToHexCodes(this.valueHex, 0, this.valueHex.byteLength);
  		object.isHexOnly = this.isHexOnly;
  ...
  class Primitive extends BaseBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = Primitive.blockName();
  ...
  class LocalConstructedValueBlock extends LocalValueBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalConstructedValueBlock.blockName();
  		object.isIndefiniteForm = this.isIndefiniteForm;
  		object.value = [];
  		for(let i = 0; i < this.value.length; i++)
  ...
  class Constructed extends BaseBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = Constructed.blockName();
  ...
  class LocalEndOfContentValueBlock extends LocalValueBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalEndOfContentValueBlock.blockName();
  ...
  class EndOfContent extends BaseBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = EndOfContent.blockName();
  ...
  class LocalBooleanValueBlock extends LocalValueBlock
  {
  	...
  	constructor(parameters = {})
  	{
  		...
  		this.isHexOnly = getParametersValue(parameters, "isHexOnly", false);
  		this.valueHex = getParametersValue(parameters, "valueHex", new ArrayBuffer(1));
  	}
  	//**********************************************************************************
  	/**
  	 * Base function for converting block from BER encoded array of bytes
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalBooleanValueBlock.blockName();
  ...
  class Boolean extends BaseBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = Boolean.blockName();
  ...
  class Sequence extends Constructed
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = Sequence.blockName();
  ...
  class Set extends Constructed
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = Set.blockName();
  ...
  class Null extends BaseBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = Null.blockName();
  ...
  class LocalOctetStringValueBlock extends LocalHexBlock(LocalConstructedValueBlock)
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalOctetStringValueBlock.blockName();
  		object.isConstructed = this.isConstructed;
  		object.isHexOnly = this.isHexOnly;
  		object.valueHex = bufferToHexCodes(this.valueHex, 0, this.valueHex.byteLength);
  ...
  class OctetString extends BaseBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = OctetString.blockName();
  ...
  class LocalBitStringValueBlock extends LocalHexBlock(LocalConstructedValueBlock)
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalBitStringValueBlock.blockName();
  ...
  class BitString extends BaseBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = BitString.blockName();
  ...
  class LocalIntegerValueBlock extends LocalHexBlock(LocalValueBlock)
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalIntegerValueBlock.blockName();
  ...
  class Integer extends BaseBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = Integer.blockName();
  ...
  class LocalSidValueBlock extends LocalHexBlock(LocalBaseBlock)
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalSidValueBlock.blockName();
  		object.valueDec = this.valueDec;
  ...
  class LocalObjectIdentifierValueBlock extends LocalValueBlock
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalObjectIdentifierValueBlock.blockName();
  ...
  class LocalUtf8StringValueBlock extends LocalHexBlock(LocalBaseBlock)
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalUtf8StringValueBlock.blockName();
  		object.value = this.value;
  ...
  class LocalBmpStringValueBlock extends LocalHexBlock(LocalBaseBlock)
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalBmpStringValueBlock.blockName();
  		object.value = this.value;
  ...
  class LocalUniversalStringValueBlock extends LocalHexBlock(LocalBaseBlock)
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalUniversalStringValueBlock.blockName();
  		object.value = this.value;
  ...
  class LocalSimpleStringValueBlock extends LocalHexBlock(LocalBaseBlock)
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = LocalSimpleStringValueBlock.blockName();
  		object.value = this.value;
  ...
  class UTCTime extends VisibleString
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = UTCTime.blockName();
  ...
  class GeneralizedTime extends VisibleString
  {
  	...
  	toJSON()
  	{
  		...
  		object.blockName = GeneralizedTime.blockName();
  		object.year = this.year;
  		object.month = this.month;
  		object.day = this.day;
  		object.hour = this.hour;
  ...
  class ECPublicKey
  {
  	...
  	fromJSON(json)
  	{
  		...
  		if("x" in json)
  			this.x = stringToArrayBuffer$1(fromBase64(json.x, true)).slice(0, coodinateLength);
  		else
  			throw new Error("Absent mandatory parameter \"x\"");

  		if("y" in json)
  			this.y = stringToArrayBuffer$1(fromBase64(json.y, true)).slice(0, coodinateLength);
  		else
  ...
  class RSAPublicKey
  {
  	...
  	{
  		if("n" in json)
  			this.modulus = new Integer({ valueHex: stringToArrayBuffer$1(fromBase64(json.n, true)).slice(0, 256) });
  		else
  			throw new Error("Absent mandatory parameter \"n\"");

  		if("e" in json)
  			this.publicExponent = new Integer({ valueHex: stringToArrayBuffer$1(fromBase64(json.e, true)).slice(0, 3) });
  		else
  ...
  class ECPrivateKey
  {
  	...
  	fromJSON(json)
  	{
  		...
  		if("d" in json)
  			this.privateKey = new OctetString({ valueHex: stringToArrayBuffer$1(fromBase64(json.d, true)).slice(0, coodinateLength) });
  		else
  ...
  class OtherPrimeInfo
  {
  	...
  	{
  		if("r" in json)
  			this.prime = new Integer({ valueHex: stringToArrayBuffer$1(fromBase64(json.r, true)) });
  		else
  			throw new Error("Absent mandatory parameter \"r\"");

  		if("d" in json)
  			this.exponent = new Integer({ valueHex: stringToArrayBuffer$1(fromBase64(json.d, true)) });
  		else
  			throw new Error("Absent mandatory parameter \"d\"");

  		if("t" in json)
  			this.coefficient = new Integer({ valueHex: stringToArrayBuffer$1(fromBase64(json.t, true)) });
  		else
  ...
  class RSAPrivateKey
  {
  	...
  	{
  		if("n" in json)
  			this.modulus = new Integer({ valueHex: stringToArrayBuffer$1(fromBase64(json.n, true, true)) });
  		else
  			throw new Error("Absent mandatory parameter \"n\"");

  		if("e" in json)
  			this.publicExponent = new Integer({ valueHex: stringToArrayBuffer$1(fromBase64(json.e, true, true)) });
  		else
  			throw new Error("Absent mandatory parameter \"e\"");

  		if("d" in json)
  			this.privateExponent = new Integer({ valueHex: stringToArrayBuffer$1(fromBase64(json.d, true, true)) });
  		else
  			throw new Error("Absent mandatory parameter \"d\"");

  		if("p" in json)
  			this.prime1 = new Integer({ valueHex: stringToArrayBuffer$1(fromBase64(json.p, true, true)) });
  		else
  			throw new Error("Absent mandatory parameter \"p\"");

  		if("q" in json)
  			this.prime2 = new Integer({ valueHex: stringToArrayBuffer$1(fromBase64(json.q, true, true)) });
  		else
  			throw new Error("Absent mandatory parameter \"q\"");

  		if("dp" in json)
  			this.exponent1 = new Integer({ valueHex: stringToArrayBuffer$1(fromBase64(json.dp, true, true)) });
  		else
  			throw new Error("Absent mandatory parameter \"dp\"");

  		if("dq" in json)
  			this.exponent2 = new Integer({ valueHex: stringToArrayBuffer$1(fromBase64(json.dq, true, true)) });
  		else
  			throw new Error("Absent mandatory parameter \"dq\"");

  		if("qi" in json)
  			this.coefficient = new Integer({ valueHex: stringToArrayBuffer$1(fromBase64(json.qi, true, true)) });
  		else
